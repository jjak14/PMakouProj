...
<head>
  ...
  <!-- My style for Peuhmakounjouh -->
  <link rel="stylesheet" href="<?= BASE_ASSET; ?>/admin-lte/myAssets/style.css">
  <style type="text/css">
    .login-box-body {
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="" style="text-shadow: 2px 2px 2px white !important;"><b><?= cclang('login'); ?></b>
        <br><img src="/asset/img/logo.png" width="150" height="150">
