...
<section class="content-header">
    <h1>
        Gallerie        <small>Edit Gallerie</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Gallerie</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/gallerie/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_gallerie', 
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="gallerie_photos_uuid" id="gallerie_photos_uuid" type="hidden" value="<?= set_value('gallerie_photos_uuid'); ?>">
                                <input class="data_file" name="gallerie_photos_name" id="gallerie_photos_name" type="hidden" value="<?= set_value('gallerie_photos_name', $gallerie->photos); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datetimepicker" name="datePublication"  placeholder="DatePublication" id="datePublication" value="<?= set_value('datePublication', $gallerie->datePublication); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
    ...
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          ...
          if(res.success) {
            var id = $('#gallerie_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#gallerie_photos_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/gallerie/get_photos_file/<?= $gallerie->idGallerie; ?>',
