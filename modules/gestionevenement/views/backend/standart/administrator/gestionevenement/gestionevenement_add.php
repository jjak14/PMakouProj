...
<section class="content-header">
    <h1>
        Gestionevenement        <small><?= cclang('new', ['Gestionevenement']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Gestionevenement']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                        ...
                        ?>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="Titre" id="Titre" placeholder="Titre" value="<?= set_value('Titre'); ?>">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="gestionevenement_photo_uuid" id="gestionevenement_photo_uuid" type="hidden" value="<?= set_value('gestionevenement_photo_uuid'); ?>">
                                <input class="data_file" name="gestionevenement_photo_name" id="gestionevenement_photo_name" type="hidden" value="<?= set_value('gestionevenement_photo_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/gestionevenement/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          ...
          if(res.success) {
            var id_photo = $('#gestionevenement_photo_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_photo !== 'undefined') {
                    $('#gestionevenement_photo_galery').fineUploader('deleteFile', id_photo);
                }
