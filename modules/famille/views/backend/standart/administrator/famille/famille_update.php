            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/famille/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_famille', 
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nomFamille" id="nomFamille" placeholder="NomFamille" value="<?= set_value('nomFamille', $famille->nomFamille); ?>">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="nombreEnfant" id="nombreEnfant" placeholder="NombreEnfant" value="<?= set_value('nombreEnfant', $famille->nombreEnfant); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="descriptionFamille" name="descriptionFamille" rows="10" cols="80"> <?= set_value('descriptionFamille', $famille->descriptionFamille); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="dateMarriage"  placeholder="DateMarriage" id="dateMarriage" value="<?= set_value('famille_dateMarriage_name', $famille->dateMarriage); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-8">
                                <textarea id="adresse" name="adresse" rows="10" cols="80"> <?= set_value('adresse', $famille->adresse); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
